  ...
  var Module = (() => {
    ...
    return async function () {
      ...
      if (ENVIRONMENT_IS_NODE) {
        ...
        var require$1 = createRequire((typeof document === 'undefined' && typeof location === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : typeof document === 'undefined' ? location.href : (document.currentScript && document.currentScript.src || new URL('decoder-pro-hard.js', document.baseURI).href)));
        ...
        if (ENVIRONMENT_IS_WORKER) {
          ...
          scriptDirectory = require$1("url").fileURLToPath(new URL("./", (typeof document === 'undefined' && typeof location === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : typeof document === 'undefined' ? location.href : (document.currentScript && document.currentScript.src || new URL('decoder-pro-hard.js', document.baseURI).href))));
        }
      ...
      if (Module["locateFile"]) {
        ...
        wasmBinaryFile = new URL("decoder-pro-audio.wasm", (typeof document === 'undefined' && typeof location === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : typeof document === 'undefined' ? location.href : (document.currentScript && document.currentScript.src || new URL('decoder-pro-hard.js', document.baseURI).href))).href;
      }
