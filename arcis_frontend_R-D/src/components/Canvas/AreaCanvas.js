...
const AreaCanvas = ({ isOpen, onClose, onCanvasData, existingCoordinates, existingDirection, existingAction, deviceId }) => {
    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose} size="full">
            <ModalOverlay />
            <ModalContent>
                <ModalHeader>Draw Properly Area Detection</ModalHeader>
                <ModalCloseButton />
                <ModalBody>
                    <Flex direction="row" align="center" gap={4}>
                        <FormControl display="flex" alignItems="center">
                            <FormLabel marginBottom="0">Action</FormLabel>
                            <Select width="auto" onChange={handleActionChange} value={action}>
                    ...
                    <Flex direction="row" align="center" gap={4}>
                        <FormControl display="flex" alignItems="center">
                            ...
                            <Select width="auto" onChange={handleDirectionChange} value={direction}>
