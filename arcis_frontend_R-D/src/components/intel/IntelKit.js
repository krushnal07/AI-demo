...
export const useIntelTheme = () => ({
  ...
  panel: useColorModeValue("#FFFFFF", "#1C222D"),
  panelAlt: useColorModeValue("#F7F9FC", "#161C26"),
  border: useColorModeValue("#E4E9F0", "rgba(255, 255, 255, 0.08)"),
  borderStrong: useColorModeValue("#D3DBE6", "rgba(255, 255, 255, 0.16)"),
  shadow: useColorModeValue(
    "0 1px 2px rgba(16,24,40,.04), 0 8px 20px -8px rgba(16,24,40,.10)",
    "0 1px 3px rgba(0,0,0,.4), 0 8px 20px -8px rgba(0,0,0,.6)"
  ),
  heading: useColorModeValue("#0F172A", "#FFFFFF"),
  body: useColorModeValue("#475569", "#CBD5E1"),
  muted: useColorModeValue("#7C8AA0", "#94A3B8"),
  track: useColorModeValue("#EEF2F7", "rgba(255, 255, 255, 0.06)"),
  // validated categorical slots 1-6
  s1: useColorModeValue("#2a78d6", "#63B3ED"),
