...
const API_URL = process.env.REACT_APP_FACE_SEARCH_URL || "https://vmschatbot.vmukti.com:21883/api/search";
      ...
      >
        <Box>
          ...
          <Text
            ...
            mt="2px"
          >
            Upload a photograph &mdash; every stored image of the same face is returned, with where and when it was taken
          </Text>
        </Box>
        {(file || data) && (
          <Button
